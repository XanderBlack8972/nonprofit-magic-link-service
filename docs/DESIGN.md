...
> Design notes for **nonprofit-magic-link-service** — a runnable typescript example that Typed magic-link access to nonprofit receipts, reminders, and campaign reporting.
...
- **Feature code** — the actual task: nonprofit member access.
